...
declare interface AipNlp {
	 ...
	 * @return  
	 */
	lexer(text : string, options : any): Promise;
	 ...
	 * @return  
	 */
	lexerCustom(text : string, options : any): Promise;
	 ...
	 * @return  
	 */
	depparser(text : string, options : any): Promise;
	 ...
	 * @return  
	 */
	wordembedding(word : string, options : any): Promise;
	 ...
	 * @return  
	 */
	dnnlmCn(text : string, options : any): Promise;
	 ...
	 * @return  
	 */
	wordSimEmbedding(word1 : string, word2 : string, options : any): Promise;
	 ...
	 * @return  
	 */
	simnet(text1 : string, text2 : string, options : any): Promise;
	 ...
	 * @return  
	 */
	commentTag(text : string, options : any): Promise;
	 ...
	 * @return  
	 */
	sentimentClassify(text : string, options : any): Promise;
	 ...
	 * @return  
	 */
	keyword(title : string, content : string, options : any): Promise;
	 ...
	 * @return  
	 */
	topic(title : string, content : string, options : any): Promise;
	 ...
	 * @return  
	 */
	ecnet(text : string, options : any): Promise;
	 ...
	 * @return  
	 */
	emotion(text : string, options : any): Promise;
	 ...
	 * @return  
	 */
	newsSummary(content : string, maxSummaryLen : number, options : any): Promise;
}
